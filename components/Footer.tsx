...
const QUICK_LINKS = [
  ...
  { label: "Get a Quote", href: "/enquiry-now" },
];
...
const SERVICES = [
  ...
  { label: "Roof Cleaning", href: "/roof-cleaning" },
  { label: "Fascia & Soffit Cleaning", href: "/fascia-soffit-cleaning" },
  ...
  { label: "Graffiti Removal", href: "/graffiti-cleaning" },
  { label: "Commercial Gutter Cleaning", href: "/commercial-gutter" },
];
                  ...
                  },
                  {
                    icon: (
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 001.144-.742 19.58 19.58 0 002.683-2.282c1.944-2.003 3.5-4.697 3.5-8.327a8 8 0 10-16 0c0 3.63 1.556 6.324 3.5 8.327a19.58 19.58 0 002.683 2.282 16.975 16.975 0 001.144.742zM12 13.5a3 3 0 100-6 3 3 0 000 6z"
                          clipRule="evenodd"
                        />
                      </svg>
                    ),
